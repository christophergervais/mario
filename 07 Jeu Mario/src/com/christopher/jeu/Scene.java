...
public class Scene extends JPanel {
	...
	private int ySol; // permet de repérer la hauteur courante du sol
	...
	public Scene() {
		...
		this.ySol = 293; //normalement à zéron mais on peut modifier plus facilement 
		this.hauteurPlafond = 0; //normalement à zéron mais on peut modifier plus facilement 
	...
	public void paintComponent(Graphics g) { //on 'peint' les images qu'on a mis ds ds variables img[nom]
		...
		//detection contact déplacé juste avant les déplacement du fond et perso sinon le perso ne s'arrete pas 
		...
		//g2.drawImage(this.mario.marche("mario",25), 300, 245, null); // code provisoire a partir de 07 jeu mario
		...
		g2.drawImage(this.tuyauRouge1.getImgTuyauRouge(),this.tuyauRouge1.getX(),this.tuyauRouge1.getY(),null); // on a enlevé "- this.xPos"
